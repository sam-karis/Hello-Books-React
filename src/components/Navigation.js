        ...
        return (
            <div >
                <Navbar color='light' id='header' light expand='md'>
                    <Link to="/" className="navbar-brand">Hello Books</Link>
                    ...
                    <Collapse isOpen={this.state.isOpen} navbar>
                        <Nav className="ml-auto" navbar>
                            ...
                            <NavItem>
                                <Link to="/auth" className="nav-link">About Us</Link>
                            </NavItem>
                            ...
                            <Fragment>
                            <NavItem>
                                <Link to="/books" className="nav-link">History</Link>
                            </NavItem>
                            <UncontrolledDropdown>
                                <DropdownToggle nav caret>{this.props.auth.username}</DropdownToggle>
                                <DropdownMenu>
